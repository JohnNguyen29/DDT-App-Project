...
all_standards = [
    ...
    ('13BIO', 'Biology 3.1 - Carry out a practical investigation in a biological context, with guidance', 'Internal', 4),
    ('13BIO', 'Biology 3.2 - Integrate biological knowledge to develop an informed response to a socio-scientific issue', 'Internal', 3),
    ('13BIO', 'Biology 3.4 - Demonstrate understanding of how an animal maintains a stable internal environment','Internal', 3),
    ('13BIO', 'Biology 3.5 - Demonstrate understanding of evolutionary processes leading to speciation','External', 4),
    ('13BIO', 'Biology 3.6 - Demonstrate understanding of trends in human evolution', 'External', 4),
    ('13CHE', 'Chemistry 3.2 - Demonstrate understanding of spectroscopic data in chemistry', 'Internal', 3),
    ('13CHE', 'Chemistry 3.3 - Demonstrate understanding of chemical processes in the world around us', 'Internal', 3),
    ('13CHE', 'Chemistry 3.4 - Demonstrate understanding of thermochemical principles and the properties of particles and substances', 'External', 5),
    ('13CHE', 'Chemistry 3.5 - Demonstrate understanding of the properties of organic compounds', 'External', 5),
    ('13CHE', 'Chemistry 3.6 - Demonstrate understanding of equilibrium principles in aqueous systems', 'External', 5),
    ('13CHE', 'Chemistry 3.7 - Demonstrate understanding of oxidation-reduction processes', 'Internal', 3),
